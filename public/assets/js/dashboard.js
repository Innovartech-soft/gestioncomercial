...
/*
  ...
  if ($('#storageChart1').length) {
    $.ajax({
      url: 'https://hereled.test/api/clientesDeudores',// Reemplaza 'URL_DEL_SERVIDOR_AQUI' con la URL real de tu servidor
      //1|6ev95YKK6zcE1s3ionCqRe8Q7cjjTqKPaqwgWtOR 
      headers: {
              ...
              dataLabels: {
                ...
                value: {
                  ...
                  formatter: function (val) {
                    val = data.response;
                    return val; // Muestra el valor sin el signo de porcentaje
                  }
                }
              }
            }
  ...
  if ($('#storageChart2').length) {
    $.ajax({
      url: 'https://hereled.test/api/getchequesDisponibles',// Reemplaza 'URL_DEL_SERVIDOR_AQUI' con la URL real de tu servidor
      //1|6ev95YKK6zcE1s3ionCqRe8Q7cjjTqKPaqwgWtOR 
      headers: {
        'Authorization': 'Bearer ' + token,
      },
  ...
  if ($('#storageChart4').length) {
    $.ajax({
      url: '/api/getchequesDssisponibles',// Reemplaza 'URL_DEL_SERVIDOR_AQUI' con la URL real de tu servidor
      //1|6ev95YKK6zcE1s3ionCqRe8Q7cjjTqKPaqwgWtOR 
      headers: {
        'Authorization': 'Bearer ' + token,
      },
      ...
      success: function (data) {
        var options = {
          ...
          labels: ["Productos en stock minimo"]
        };
  ...
  if ($('#storageChart5').length) {
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        var chart = new ApexCharts(document.querySelector("#storageChart5"), options);
        chart.render();
      },
      error: function (error_data) {
        console.log("error");
  ...
  if ($('#storageChart6').length) {
    $.ajax({
      ...
      success: function (data) {
        ...
        var chart = new ApexCharts(document.querySelector("#storageChart6"), options);
        chart.render();
      },
      error: function (error_data) {
        console.log("error");
