...
<div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
  <div>
    <h4 class="mb-3 mb-md-0">Listas</h4>
  </div>
  <div class="d-flex align-items-center flex-wrap text-nowrap">
    <a href="{{ route('lista.create') }}" class="btn btn-primary mr-3 mr-md-2"><i class="mdi mdi-plus-circle mr-1"></i>
      Nuevo</a>
  </div>
</div>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="table-responsive">
          <table id="dataTableListas" class="table">
            <thead>
              <tr>
                <th>#ID</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{ $lista->valor }}%</td>
                <td class="text-end">
                  <a href="{{ route('lista.edit',$lista->id) }}" class="btn btn-primary btn-sm"><i
                      class="mdi mdi-pencil"></i></a>

                  <form onsubmit="eliminarAlert(event)" action="{{ route('lista.destroy',$lista->id) }}" method="POST"
